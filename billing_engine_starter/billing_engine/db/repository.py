...
from billing_engine.db.database import Database # type: ignore
from billing_engine.db import queries as q # type: ignore
from billing_engine.money import Money # type: ignore
from billing_engine.models import ( # type: ignore
    Customer,
...
class LedgerRepository:
    ...
    customer_id: int,
     ...
     with self.db.connect() as conn:
        rows = q.select_ledger_for_customer(
            conn,
            customer_id,
        )
